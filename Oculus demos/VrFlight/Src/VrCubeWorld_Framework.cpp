...
static const unsigned short cubeIndices[36] =
{
	...
	/*
	 * CONFIGURATION CLASS FOR ME TO MODIFY
	 */
...
float Java_com_oculus_vrcubeworld_MainActivity_getHeadSetYaw(JNIEnv * jni, jclass clazz) {
	return OVR::VrCubeWorld::theYaw;
}

float Java_com_oculus_vrcubeworld_MainActivity_getHeadSetRoll(JNIEnv * jni, jclass clazz) {
	return OVR::VrCubeWorld::theRoll;
}

float Java_com_oculus_vrcubeworld_MainActivity_getHeadSetPitch(JNIEnv * jni, jclass clazz) {
	return OVR::VrCubeWorld::thePitch;
}
