...
public class G3MGlassesDemoMainActivity
   ...
   protected void onCreate(final Bundle savedInstanceState) {
      ...
      final URLTemplateLayer greyLayer = URLTemplateLayer.newWGS84("file:///__TEXTURE_gray.png", Sector.FULL_SPHERE, false,
      ...
      final HUDQuadWidget xImg = new HUDQuadWidget(new DownloaderImageBuilder(new URL("file:///x.png")), new HUDRelativePosition(
               ...
               HUDRelativePosition.Anchor.VIEWPORT_HEIGHT, HUDRelativePosition.Align.MIDDLE), new HUDRelativeSize(0.25f,
      ...
      gestureDetector.setBaseListener(new GestureDetector.BaseListener() {
         ...
         public boolean onGesture(final Gesture gesture) {
            if (gesture == Gesture.TWO_TAP) {
               ...
               final Touch t = new Touch(new Vector2F(320, 180), new Vector2F(320, 180));
