...
import org.glob3.mobile.generated.HUDAbsoluteSize;
...
import org.glob3.mobile.generated.HUDRelativeSize.Reference;
...
import org.glob3.mobile.generated.HUDRelativePosition.Align;
import org.glob3.mobile.generated.HUDRelativePosition.Anchor;
...
import org.glob3.mobile.generated.SectorAndHeightCameraConstrainer;
...
import com.globoulpgc.g3moculusdemo.R;
    ...
    private void setGlobe(boolean withHeadset){
		...
		hudRenderer.addWidget(new HUDQuadWidget(
				new LabelImageBuilder("Usa el trackpad para moverte atrás o adelante",
						GFont.sansSerif(),
						32),
				new HUDRelativePosition(0.85f, Anchor.VIEWPORT_WIDTH, Align.LEFT),
				new HUDRelativePosition(0.5f, Anchor.VIEWPORT_HEIGHT, Align.ABOVE),
				new HUDRelativeSize(0.7f,Reference.VIEWPORT_WIDTH),
				new HUDRelativeSize(0.2f,Reference.VIEWPORT_HEIGHT)));
